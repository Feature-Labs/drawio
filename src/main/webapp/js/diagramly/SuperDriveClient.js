...
(function()
{
    ...
    window.SuperDriveClient = function(editorUi, isExtAuth)
    {
...
// Extends DrawioClient
     ...
     * @param id
     * @param body
     * @returns {{method: string, params, contentType: string, url: string}}
     */
...
//					'\n\nStack:\n' + e.stack);
     ...
     * @param etag
     * @param pinned
     * @returns {{headers: {"Content-Type": string}, method: (string), fullUrl: string, params: string}}
     */
     ...
     * 清除持久化Token
     */
    SuperDriveClient.prototype.clearPersistentToken = function()
    {
     ...
     * @param sessionOnly
     */
    SuperDriveClient.prototype.setPersistentToken = function(userAuthInfo, sessionOnly)
    {
        var authInfo = JSON.parse(this.getPersistentToken(true)) || {};
